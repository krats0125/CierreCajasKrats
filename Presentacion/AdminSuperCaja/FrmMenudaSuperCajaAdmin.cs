...
{
    public partial class FrmMenudaSuperCajaAdmin : Form
    {
        FrmResumenSuperCajaAdmin supercaja=null;
        private Menuda oMenuda;
        public decimal valorentregado = 0;
        public FrmMenudaSuperCajaAdmin(FrmResumenSuperCajaAdmin supercaja)
        {
            InitializeComponent();
        ...
        private void FrmMenudaSuperCajaAdmin_Load(object sender, EventArgs e)
        {
            try
            {
                oMenuda.IdCierre = supercaja.IdCierre;
                MenudaSuperCajaRepository menuda = new MenudaSuperCajaRepository();
        ...
        public void actualizardenominacion()
        {
            try
            {
                oMenuda.IdUsuario = supercaja.IdUsuario;
                oMenuda.IdCierre = supercaja.IdCierre;
                ...
                bool seInserto = new MenudaSuperCajaRepository().insertar(oMenuda);
                ...
                if (seInserto)
                {
                    ...
                    if (frmSc != null)
                    {
                        bool actualicionExitosa = new SuperCajaAdminRepository(supercaja).ActualizarCierre(supercaja.IdCierre);
                        if (!actualicionExitosa)
                        {
