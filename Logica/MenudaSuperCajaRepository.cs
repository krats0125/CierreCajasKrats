...
{
    public class MenudaSuperCajaRepository
    {
        ...
        public bool insertar(Menuda oMenuda)
        {
            ...
            try
            {
                using (SqlConnection conexion = new SqlConnection(cn.ConexionCierreCaja()))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("usp_InsertarDenominacionessupercaja", conexion))
                    {
        ...
        public bool CargarDenominaciones(Menuda oMenuda)
        {
            try
            {
                ...
                {
                    conexion.Open();
                    using (SqlCommand cmd = new SqlCommand("usp_CargarDenominacionesupercaja", conexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@IdCierre", oMenuda.IdCierre);
